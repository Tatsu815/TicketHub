...
export default function EventPage({ params }: EventPageProps) {
  // For this example, we'll only implement the YÊU concert page
  if (params.id !== "yen-concert") {
    return notFound()
  }
              ...
              <div className="mb-8">
                ...
                <div className="prose max-w-none">
                  <p>
                    ...
                    cảm xúc của tình yêu thông qua các tác phẩm âm nhạc đã làm nên tên tuổi của Hoàng Dũng.
                  </p>
                  <p>
