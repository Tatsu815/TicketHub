...
export default function NhungThanhPhoMoMangTicketSelection() {
  ...
  const eventDetails = {
    title: "Những Thành Phố Mơ Màng Autumn",
    date: "09.09.2023 (16:00 - 22:30)",
  ...
  const getSelectedPrice = () => {
    return ticketType === "vip" ? eventDetails.vipPrice : eventDetails.regularPrice
  }

  const getTicketTypeName = () => {
    return ticketType === "vip" ? "VIP" : "Thường"
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-5 bg-white p-6 rounded-lg">
          ...
          {/* VIP ticket */}
          <div
            className={`border rounded-lg p-4 mb-4 cursor-pointer ${ticketType === "vip" ? "border-[#f08c5a] bg-orange-50" : ""}`}
          ...
          {/* Regular ticket */}
          <div
            className={`border rounded-lg p-4 mb-4 cursor-pointer ${ticketType === "regular" ? "border-[#f08c5a] bg-orange-50" : ""}`}
          ...
          <div className="flex justify-between mt-8">
            <Button variant="outline" className="bg-gray-200 border-none">
              <Link href="/su-kien/nhung-thanh-pho-mo-mang">Quay lại</Link>
            </Button>
            <Button className="bg-[#f08c5a] hover:bg-[#e67a48] text-white">Tiếp theo</Button>
          </div>
        </div>
        ...
        <div className="md:col-span-4 bg-white p-6 rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full bg-[#f08c5a] hover:bg-[#e67a48] text-white">Mua vé</Button>
          </div>
        </div>
      </div>
    </div>
